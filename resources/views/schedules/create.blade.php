@extends('layouts.app') @section('title', 'Horario') @section('content')
<div class="row">
	<div class="col-md-12">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-md-4 col-sm-8 col-xs-12">
						{{Form::select('cicloAcademico',$cycles,null,['id' => 'academicCycle','placeholder' => 'Elegir','class'=>'form-control',
						'required'])}}
					</div>
				</div>
				<div class="form-group">
				...
				<div class="table-responsive">
					<table class="table table-list-search table-striped responsive-utilities jambo_table bulk_action">
						...
						<tbody class="listOfCourses">
							...
							@include('modals.course', ['id'=> $course->id, 'course' => $course]) @endforeach
						</tbody>
					</table>
				</div>
