    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-default">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    {{Form::text('codigo',$student->codigo,['class'=>'form-control', 'readonly', 'maxlength' => 8])}}                    
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    {{Form::text('dni',$student->dni,['class'=>'form-control', 'readonly', 'maxlength' => 8])}}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    {{Form::text('nombres',$student->nombres,['class'=>'form-control', 'readonly', 'maxlength' => 50])}}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    {{Form::text('apellidoPaterno',$student->apellidoPaterno,['class'=>'form-control', 'readonly', 'maxlength' => 50])}}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    {{Form::text('apellidoMaterno',$student->apellidoMaterno,['class'=>'form-control', 'readonly', 'maxlength' => 50])}}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    {{Form::text('telefono',$student->telefono,['class'=>'form-control', 'readonly', 'maxlength' => 50])}}
                </div>
            </div>

            <div class="row">
                <div class="col-md-8 col-sm-12 col-xs-12">                    
                    <a class="btn btn-success pull-right" href="{{ route('alumno.index') }}">Regresar</a>
                </div>
            </div>
