        ...
        <div class="panel panel-default">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-8 col-xs-12">
                    {{Form::selectRange('nivelAcademico',1,10,null,['id' => 'cycleOfCourse','placeholder' => 'Elegir','class'=>'form-control', 'required'])}}
                </div>
            </div>            
